    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="offers.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Manage Offers</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid px-4">
                <div class="row my-5">
                    <div class="col">
                        <a href="offers.php?action=add" class="btn btn-success mb-3">Add New Offer</a>
                            ...
                            <tbody>
                                <?php foreach ($data['offers'] as $offer) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo $offer->points; ?></td>
                                        <td><?php echo $offer->is_active ? 'Yes' : 'No'; ?></td>
                                        <td>
                                            <a href="offers.php?action=edit&id=<?php echo $offer->id; ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <form action="offers.php?action=delete&id=<?php echo $offer->id; ?>" method="POST" class="d-inline">
