...
<body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Watch Ads</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><strong>Points:</strong> <?php echo $ad->points; ?></p>
                                        <button class="btn btn-primary watch-ad" data-ad-id="<?php echo $ad->id; ?>">Watch Ad</button>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div id="ad-message" class="mt-3"></div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo BASE_URL; ?>/public/js/ads.min.js"></script>
    <script>
